...
<head>
  ...
  <meta name="DCTERMS.identifier" scheme="DCTERMS.URI" content="https://agriculture.vic.gov.au/copyright">
  <script>
    var parentChild = '/vro/search';
  </script>
  <script>
    ...
    ga('create', 'UA-2063136-9', 'auto', {
      'name': 'WoVGtracker'
    });
    ga('create', 'UA-17425154-1', 'auto', {
      'name': 'VROUAtracker'
    });
    ga('create', 'UA-65891253-1', 'auto', {
      'name': 'AGUAtracker'
    });
    ...
    ga('WoVGtracker.send', 'pageview', {
      'page': 'DEDJTR/agriculture.vic.gov.au' + parentChild
    });
    ga('VROUAtracker.send', 'pageview');
    ga('AGUAtracker.send', 'pageview', {
      'page': 'VRO' + parentChild
    });
  </script>
...
<body>
  ...
  <div class="row vro-banner">
    <div class="col-sm-3">
      <p class="hide">Your gateway to a wide range of natural resources information and associated maps</p>
    </div>
    <div class="col-sm-9">
      <p class="hide">Victorian Resources Online</p>
    </div>
  </div>
  <nav class="navbar">
  ...
  <div class="container-fluid">
    <div class="row row-offcanvas row-offcanvas-right">
      ...
      <div class="col-xs-12 col-sm-8 col-md-9">
        ...
        <div class="row vro-search-body">
          ...
          $protocol = "https://";
          $host = "djpr-search.squiz.cloud";
          $base_path = "/s/search.html?";
          // Don't forget to input your collection name below
          $default_cgi_string = "collection=vro-web-html&query=";
    ...
    <div class="row vro-footer">
      ...
      <div class="col-sm-8 col-sm-offset-4 col-md-offset-3 col-xs-12 vro-footer-banner">
        <a href="//www.vic.gov.au"><img src="https://vromedia.agriculture.vic.gov.au/assets/graphics/vicgov-dedjtr-black.png" height="64" alt="State Government of Victoria logo - link to Victorian Government home" usemap="#vicgov-dedjtr-black">
          <map name="vicgov-dedjtr-black">
            <area shape="rect" coords="0,0,129,64" href="https://www.vic.gov.au">
            <area shape="rect" coords="129,0,287,64" href="https://economicdevelopment.vic.gov.au">
          </map>
        </a>
        ...
        <p>The licence does not apply to &#8216;branding&#8217; or some &#8216;images or photographs&#8217; that may be owned by third parties. We ask you to seek prior approval to use images using the <a href="https://vro.agriculture.vic.gov.au/dpi/vro/vrosite.nsf/pages/feedback ">VRO feedback form</a>. Access to higher quality images can also be provided on request.</p><br>
        <p>This page was last updated on 17/05/2022.</p>
  ...
  <script src="https://vromedia.agriculture.vic.gov.au/assets/js/vro.cumulative.js"></script>
</body>
</html>